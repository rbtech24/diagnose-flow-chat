...
import { BarChart, Eye, Clock, GitBranch, Users, GripHorizontal, Move } from 'lucide-react';
...
export function WorkflowOverview({ nodes, edges, currentWorkflow }: WorkflowOverviewProps) {
  ...
  const handleMouseDown = (e: React.MouseEvent) => {
    ...
    // Only allow dragging when clicking on the grip icon or its container
  ...
  return (
    ...
    >
      <div className="bg-white rounded-lg shadow-lg border flex items-center overflow-hidden">
        {/* Drag Handle */}
        <div 
          className={`drag-handle p-2 bg-gray-50 border-r hover:bg-gray-100 transition-colors ${isDragging ? 'cursor-grabbing' : 'cursor-grab'}`}
